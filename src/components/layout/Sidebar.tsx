    ...
    <ShadcnSidebar>
      <SidebarHeader className="py-4">
        <div className="flex flex-col items-center justify-center px-4">
          <h1 className="text-2xl font-bold text-white">SMAIPA</h1>
          <p className="text-xs text-sidebar-foreground/80">Sistema de Monitoramento e Avaliação</p>
          {user?.schoolName && (
            <div className="mt-2 px-3 py-1 bg-sidebar-accent rounded-md text-xs">
              {user.schoolName}
            </div>
          )}
        </div>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarLink 
                ...
                label="Avaliações" 
                active={location.pathname.startsWith('/avaliacoes')}
              />
              ...
              <SidebarLink 
                ...
                label="Gabaritos" 
                active={location.pathname.startsWith('/gabaritos')}
              />
              ...
              <SidebarLink 
                ...
                label="Respostas" 
                active={location.pathname.startsWith('/respostas')}
              />
              ...
              <SidebarLink 
                ...
                label="Descritores" 
                active={location.pathname.startsWith('/descritores')}
              />
            </SidebarMenu>
          </SidebarGroupContent>
        </SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarLink 
                  ...
                  label="Escolas" 
                  active={location.pathname.startsWith('/escolas')}
                />
                ...
                <SidebarLink 
                  ...
                  label="Turmas" 
                  active={location.pathname.startsWith('/turmas')}
                />
                <SidebarLink 
                  to="/alunos" 
                  icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.655 6.879 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>} 
                  label="Alunos" 
      ...
      <SidebarFooter className="px-4 py-2">
        <div className="flex flex-col space-y-2">
          <div className="flex items-center space-x-2 p-2 rounded-md bg-sidebar-accent text-white text-sm">
          ...
          <Button 
            variant="outline" 
            size="sm" 
            className="w-full bg-red-500/10 hover:bg-red-500/20 border-red-500/20 text-white" 
            onClick={logout}
          >
